...
class Inicio(Frame):
    def __init__(self,ventana):
        ...
        bibi1="¡Hola! Mi nombre es Kevin Ramos, soy de Villavicencio y tengo 20 años, actualmente estoy cursando mi tercer semestre en Ingeniería de Sistemas e Informática en la Universidad Nacional de Colombia sede Medellín. En mi tiempo libre, disfruto de los videojuegos, la lectura y la enseñanza. Me agrada entender los objetivos al momento de programar y explorar nuevas perspectivas para dar soluciones a los problemas que se presenten."
