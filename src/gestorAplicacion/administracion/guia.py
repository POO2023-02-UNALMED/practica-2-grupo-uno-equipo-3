...
class Guia:
    ...
    def __str__(self):
        ...
        table += "+--------------------+--------------------+\n"
        table += format_str.format("Ciudad Origen", str(self._sucursalOrigen)) + "\n"
        table += "+--------------------+--------------------+\n"
        table += format_str.format("Ciudad Destino", str(self._sucursalLlegada)) + "\n"
        table += "+--------------------+--------------------+\n"
        ...
        table += "+--------------------+--------------------+\n"
        table += format_str.format("Vehículo", str(self._vehiculo)) + "\n"
        table += "+--------------------+--------------------+\n"
        return table
